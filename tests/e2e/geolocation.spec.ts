...
test("affiche une position approximative puis affine sans bloquer la recherche", async ({ page, context }) => {
  ...
  await button.click();
  await expect(page.getByText(/Position non obtenue pour le parc/)).toBeVisible();
